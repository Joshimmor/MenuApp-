...
})({"l1GmD":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "0fc34a0e057cbd56";
"use strict";
...
var _vendorListModelJs = require("./VendorListModel.js");
var _vendorListModelJsDefault = parcelHelpers.interopDefault(_vendorListModelJs);
class NavBar {
    constructor(Vendors1){
    ...
    ClickButton(place) {
        ...
        for(let i = 0; i < this.ButtonList.length; i++)if (this.ButtonList[i].children[0].classList.contains("active")) {
...
class TopVendors {
    ...
    constructor(TopVendors1){
        this.TopVendorsList = TopVendors1;
    ...
    displayCurrentVendor(place1) {
        ...
        image.src = this.TopVendorsList[place1].image;
        let cardBody = document.createElement("div");
        cardBody.classList.add('card-body');
        let cardText = document.createElement("p");
        cardText.classList.add("card-text");
        cardText.innerHTML = this.TopVendorsList[place1].description;
        let button = document.createElement('button');
        button.classList.add('btn');
        button.classList.add('btn-dark');
        button.onclick = ()=>this.navToNextPage(this.TopVendorsList[place1])
        ;
...
class app {
    Vendors = new _vendorListModelJsDefault.default();
    Selected;
    constructor(){
...
},{"./VendorListModel.js":"iGkin","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"iGkin":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ResturantModel", ()=>ResturantModel
);
var _foodItemModelJs = require("./FoodItemModel.js");
class ResturantModel {
    ...
    constructor(id, resturantName, foodStyle, image, description, menu = []){
        ...
        menu.forEach((n)=>{
            let newFood = new _foodItemModelJs.FoodItem(n.Food, n.Price);
...
class VendorList1 {
    ...
    async fetchData() {
        fetch("https://my.api.mockaroo.com/570_app.json?key=bcc7d090").then((response)=>response.json()
        ).then((response)=>{
            response.forEach((n, i)=>{
                ...
                if (i <= 2) this.TopVendorsList.push(n);
            });
        });
    //console.log(this.TopVendorsList)
    }
    searchfilter(evn) {
        ...
        for(let i = 0; i < currentDisplayArray.length; i++)currentDisplayArray[i].remove();
        if (evn.keycode == 46 || evn.keycode == 8) this.filterResults = this.VendorList;
        else this.filterResults = this.VendorList.filter((n)=>n.resturantName.contains(value) || n.foodStyle.contains(value)
        );
        this.filterResults.forEach((n)=>this.createVendorModel(n)
        );
    }
...
exports.default = VendorList1;

},{"./FoodItemModel.js":"cCL2B","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"cCL2B":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}]},["l1GmD","3auaO"], "3auaO", "parcelRequire575b")

//# sourceMappingURL=index.057cbd56.js.map
